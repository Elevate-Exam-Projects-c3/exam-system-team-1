...
namespace exam_system.Features.Diplomas.EnrollDiploma.Handlers
{
    ...
    public class GetExistingEnrollmentQueryHandler : IRequestHandler<GetExistingEnrollmentQuery, RequestResponse<bool>>
    {
        ...
        public async Task<RequestResponse<bool>> Handle(GetExistingEnrollmentQuery request, CancellationToken cancellationToken)
        {
            ...
            return count > 0
                    ? RequestResponse<bool>.Fail(ErrorType.Conflict, "Student is already enrolled in this diploma")
